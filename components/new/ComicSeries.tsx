  ...
  const noPlaneSeries = [
    {
      ...
      image: "/No Plane Adventures/Maroc-preview.png",
      ...
      <div className="py-32 px-6 md:px-12">
        <div className="container mx-auto max-w-7xl">
          <div className="mb-16 max-w-3xl">
            ...
            <h2 className="text-xl md:text-2xl font-medium mb-6 text-neutral-900">No Plane Adventures</h2>
      ...
      <div className="py-32 px-6 md:px-12 bg-white">
        <div className="container mx-auto max-w-7xl">
          <div className="mb-20 max-w-3xl">
            ...
            <h2 className="text-xl md:text-2xl font-medium mb-6 text-neutral-900">Standalone Stories</h2>
            <div className="w-16 h-0.5 bg-neutral-900 mb-6" />
            <p className="text-neutral-600 leading-relaxed">
